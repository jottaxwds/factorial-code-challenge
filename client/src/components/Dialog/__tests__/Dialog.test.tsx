...
describe("Dialog", () => {
  it("Should show given children", () => {
    ...
    render(<Dialog onClose={onActionHandler}><div data-testid='children'>Hey!</div></Dialog>);
  ...
  it("Should show call onClose when close button is clicked", () => {
    ...
    render(<Dialog onClose={onCloseHandler}><div data-testid='children'>Hey!</div></Dialog>);
